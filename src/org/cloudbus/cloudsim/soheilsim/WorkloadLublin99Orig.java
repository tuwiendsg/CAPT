 ...
 * @since  5.0
 */
public class WorkloadLublin99Orig implements WorkloadModel {
    ...
    * next arrival. */
     ...
     * @post $none
     */
    public WorkloadLublin99Orig(int rating, boolean jobType, long seed) {
    ...
    private boolean createGridlets() {
    	...
    	for (int i=0; i<numJobs; i++) {
           ...
           // Gridlet gl = new Gridlet(i+1, len, size, size);
            ...
            Job job = new Job(JobType.ONDEMAND, arrTime,runTime);
            jobs.add(job);
    	}
