...
public class WorkloadLublin99 implements WorkloadModel{
	private ArrayList<Job> jobs;   // a list with all the jobs generated
	...
	public static final double UMED = 4.2f;
	public static final double UHI = 5f;          // SYSTEM SIZE is 2^UHI == 128
	...
	public static final double AARR = 5.2303; 
	public static final double BARR = 0.5071;  
	public static final double ANUM = 6.1773;  
	public static final double BNUM = 2.9631;  
	...
	// go creating and submitting jobs. numJobs keeps the number of
	 ...
	 * next arrival. */
	private boolean useJobType_ = false; 
	 ...
	 * @post $none
	 */
	public WorkloadLublin99(JobType type,int timezone) {
		this(type,timezone, 0);
	}
	
	public WorkloadLublin99(JobType type,int timezone, int workloadDuration) {
		Random random = new Random(Parameters.SEED1);
		this.jobtype = type;
		this.useJobType_ = false;
		this.jobs = null;
		this.random = random;//new Random(ICProperties.IC_SIMULATION_SEED.getValueAsLong());
		start = timezone;
		...
		if (useJobType_) { 
			...
			{
			case RESERVED:
				serialProb[BATCH_JOBS] = serialProb[INTERACTIVE_JOBS] = Parameters.RESERVED_SERIAL_PROB;
				pow2Prob[BATCH_JOBS] = pow2Prob[INTERACTIVE_JOBS] = Parameters.RESERVED_POW2_PROB;
				uLow[BATCH_JOBS] = uLow[INTERACTIVE_JOBS] = Parameters.RESERVED_ULOW;
				uMed[BATCH_JOBS] = uMed[INTERACTIVE_JOBS] = Parameters.RESERVED_UMED;
				uHi[BATCH_JOBS] = uHi[INTERACTIVE_JOBS] = Parameters.RESERVED_UHI;
				uProb[BATCH_JOBS] = uProb[INTERACTIVE_JOBS] = Parameters.RESERVED_UPROB;

				a1[BATCH_JOBS] = a1[INTERACTIVE_JOBS] = Parameters.RESERVED_A1;
				b1[BATCH_JOBS] = b1[INTERACTIVE_JOBS] = Parameters.RESERVED_B1;
				a2[BATCH_JOBS] = a2[INTERACTIVE_JOBS] = Parameters.RESERVED_A2;
				b2[BATCH_JOBS] = b2[INTERACTIVE_JOBS] = Parameters.RESERVED_B2;
				pa[BATCH_JOBS] = pa[INTERACTIVE_JOBS] = Parameters.RESERVED_PA;
				pb[BATCH_JOBS] = pb[INTERACTIVE_JOBS] = Parameters.RESERVED_PB;

				aarr[BATCH_JOBS] = aarr[INTERACTIVE_JOBS] = Parameters.RESERVED_AARR * Parameters.RESERVED_ARAR;
				barr[BATCH_JOBS] = barr[INTERACTIVE_JOBS] = Parameters.RESERVED_BARR;
				anum[BATCH_JOBS] = anum[INTERACTIVE_JOBS] = Parameters.RESERVED_ANUM;
				bnum[BATCH_JOBS] = bnum[INTERACTIVE_JOBS] = Parameters.RESERVED_BNUM;
				break;
			case ONDEMAND:
				serialProb[BATCH_JOBS] = serialProb[INTERACTIVE_JOBS] = Parameters.ONDEMAND_SERIAL_PROB;
				pow2Prob[BATCH_JOBS] = pow2Prob[INTERACTIVE_JOBS] = Parameters.ONDEMAND_POW2_PROB;
				uLow[BATCH_JOBS] = uLow[INTERACTIVE_JOBS] = Parameters.ONDEMAND_ULOW;
				uMed[BATCH_JOBS] = uMed[INTERACTIVE_JOBS] = Parameters.ONDEMAND_UMED;
				uHi[BATCH_JOBS] = uHi[INTERACTIVE_JOBS] = Parameters.ONDEMAND_UHI;
				uProb[BATCH_JOBS] = uProb[INTERACTIVE_JOBS] = Parameters.ONDEMAND_UPROB;

				a1[BATCH_JOBS] = a1[INTERACTIVE_JOBS] = Parameters.ONDEMAND_A1;
				b1[BATCH_JOBS] = b1[INTERACTIVE_JOBS] = Parameters.ONDEMAND_B1;
				a2[BATCH_JOBS] = a2[INTERACTIVE_JOBS] = Parameters.ONDEMAND_A2;
				b2[BATCH_JOBS] = b2[INTERACTIVE_JOBS] = Parameters.ONDEMAND_B2;
				pa[BATCH_JOBS] = pa[INTERACTIVE_JOBS] = Parameters.ONDEMAND_PA;
				pb[BATCH_JOBS] = pb[INTERACTIVE_JOBS] = Parameters.ONDEMAND_PB;

				aarr[BATCH_JOBS] = aarr[INTERACTIVE_JOBS] = Parameters.ONDEMAND_AARR *  Parameters.ONDEMAND_ARAR;
				barr[BATCH_JOBS] = barr[INTERACTIVE_JOBS] = Parameters.ONDEMAND_BARR;
				anum[BATCH_JOBS] = anum[INTERACTIVE_JOBS] = Parameters.ONDEMAND_ANUM;
				bnum[BATCH_JOBS] = bnum[INTERACTIVE_JOBS] = Parameters.ONDEMAND_BNUM;
				break;
			/*case SPOT:
				serialProb[BATCH_JOBS] = serialProb[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_SERIAL_PROB.getValueAsDouble();
				pow2Prob[BATCH_JOBS] = pow2Prob[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_POW2_PROB.getValueAsDouble();
				uLow[BATCH_JOBS] = uLow[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_ULOW.getValueAsDouble();
				uMed[BATCH_JOBS] = uMed[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_UMED.getValueAsDouble();
				uHi[BATCH_JOBS] = uHi[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_UHI.getValueAsDouble();
				uProb[BATCH_JOBS] = uProb[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_UPROB.getValueAsDouble();

				a1[BATCH_JOBS] = a1[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_A1.getValueAsDouble();
				b1[BATCH_JOBS] = b1[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_B1.getValueAsDouble();
				a2[BATCH_JOBS] = a2[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_A2.getValueAsDouble();
				b2[BATCH_JOBS] = b2[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_B2.getValueAsDouble();
				pa[BATCH_JOBS] = pa[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_PA.getValueAsDouble();
				pb[BATCH_JOBS] = pb[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_PB.getValueAsDouble();

				aarr[BATCH_JOBS] = aarr[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_AARR.getValueAsDouble()*ICProperties.IC_SPOT_ARAR.getValueAsDouble();
				barr[BATCH_JOBS] = barr[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_BARR.getValueAsDouble();
				anum[BATCH_JOBS] = anum[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_ANUM.getValueAsDouble();
				bnum[BATCH_JOBS] = bnum[INTERACTIVE_JOBS] = ICProperties.IC_SPOT_BNUM.getValueAsDouble();
				break;*/
			}
	 ...
	 * jobs whose time of submission is less or equals to . 
	 ...
	 * <tt>false</tt> otherwise.
	 */
	public boolean setMaximumWorkloadDuration(int duration) {
		if(duration <= 0) {
			return false;
		}

		workloadDuration = (double)duration * 60 * 60;
		return true;
	}
	...
	/**
	 * Creates the jobs according to the workload model
	 * @return <tt>true</tt> if the gridlets were created successfully or
	 * <tt>false</tt> otherwise.
	 */
	private boolean createJobs() {
		...
		for (int i=0; i<numJobs; i++) {
			...
			//round up for the next hour
			//int runTimeInHours = (int) Math.ceil(runTime/(60.0*60.0));
			//runTime = runTimeInHours*60*60;

			long endTime = arrTime + runTime;
			
			jobs.add(new Job(this.jobtype, arrTime, runTime));
		}
		return true;
	}
